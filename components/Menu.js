    ...
    return(
        ...
        <div className='md:flex justify-between items-center'>
          ...
          <div className='mr-5 flex'>
            ...
            <Link href={'/team'}>
              <div className='px-5 py-2 bg-white ml-2 rounded-full text-black hover:scale-110 ease-in duration-200'>Equipo</div>
            </Link>
            <Link href={'/project'}>
              <div className='px-5 py-2 bg-white ml-2 rounded-full text-black hover:scale-110 ease-in duration-200'>Projecto</div>
            </Link>
          </div>
        </div>
      </div>
