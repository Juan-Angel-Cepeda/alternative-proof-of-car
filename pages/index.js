        ...
        <div className='w-1/2 flex  mr-10'>
          <div className='ml-12'>
            ...
            <div className='mt-5 flex justify-center'>
              ...
              <p className='mt-5 text-center tracking-tight'>Proof Of Car allows you to check your car data, as well as its history. You will be able to see how many owners it has had, the major repairs it has had, major mechanical services, and even accidents it has been involved in.</p>
          </div>
        </div>
      </div>
    </div>
